...
module placegrid (
vol, origin, grid, type, vertalign ) {	
  translate (-origin) {
...
placegrid (
  vol = [150,150,100], // 3-vector build volume
  origin = [5,5], // printer origin coordinates
  grid = 10, // grid spacing in mm
  type = 0, // 0 = rectangular, 1 = delta
  vertalign = 1 // 0 = [0,0], 1 = [xmax, ymax]
);
